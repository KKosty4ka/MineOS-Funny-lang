...
function GUI.alert(...)
	...
	local sign = image.load("/Libraries/GUI-Alert-icon.pic")
	local offset = 2
	...
	local button = workspace:addChild(GUI.roundedButton(x + image.getWidth(sign) + textWidth - buttonWidth + 2, workspace.height - offset, buttonWidth, 1, 0x3366CC, 0xE1E1E1, 0xE1E1E1, 0x3366CC, "Забыть про это дерьмо"))
