...
local function UIRequire(module)
	...
	local title, width, total = "Чего уставился?", 26, 14
	...
	-- Module name
	local text = "Загрузка библиотек " .. tostring(UIRequireCounter) .. " из " .. tostring(UIRequireTotal) .. " - " .. module
	GPUProxy.setForeground(0xC3C3C3)
	GPUProxy.fill(0, y + 2, screenWidth, y + 2, " ")
	GPUProxy.set(centrize(#text), y + 2, text)
